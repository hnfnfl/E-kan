...
interface AuthService {
    //login
    @FormUrlEncoded
    @POST("penjual/auth_penjual/login")
    fun login(
    ...
    //precheck email
    @FormUrlEncoded
    @POST("penjual/auth_penjual/precheckEmail")
    fun precheck(
        @Field("email") email: String
    ...
    //register
    @FormUrlEncoded
    @POST("penjual/auth_penjual/register")
    fun register(
    ...
    //request OTP
    @FormUrlEncoded
    @POST("penjual/auth_penjual/requestOtp")
    fun requestOtp(
        @Field("email") email: String
    ): Call<DefaultResponse>
    ...
    //verify OTP
    @FormUrlEncoded
    @POST("penjual/auth_penjual/verifyOtp")
    fun verifyOtp(
        @Field("email") email: String,
